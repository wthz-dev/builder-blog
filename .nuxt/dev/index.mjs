...
import destr, { destr as destr$1 } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/source-map/source-map.js';
...
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/worksDev/GitHub/builder-blog/.nuxt/nuxt-icon-server-bundle.mjs';
...
import { renderToString } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/worksDev/GitHub/builder-blog/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/worksDev/GitHub/builder-blog/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/worksDev/GitHub/builder-blog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/worksDev/GitHub/builder-blog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/worksDev/GitHub/builder-blog/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/worksDev/GitHub/builder-blog/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/worksDev/GitHub/builder-blog/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "cloudinaryCloudName": "dmxw2bmq7",
  "cloudinaryApiKey": "945642268655577",
  "cloudinaryApiSecret": "egITWRxlmoaa-fodA-Y5Q3DYiyg",
  "icon": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/worksDev/GitHub/builder-blog/public"
      ]
    },
    "http": {
      "domains": []
...
const _JgBqzBoNmTyDbltbJGWxK0h4WGZpdJZgvTqGzfQuU = (function(nitro) {
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"theme-color","content":"#ffffff"},{"name":"google-adsense-account","content":"8698914796866389"}],"link":[{"rel":"manifest","href":"/manifest.webmanifest"}],"style":[],"script":[],"noscript":[]};
...
const _5v03cVl4y3HiJQc9bt5nfi1lJYCkyC4pRUbeq4rkvI = (nitroApp) => {
...
const plugins = [
  _JgBqzBoNmTyDbltbJGWxK0h4WGZpdJZgvTqGzfQuU,
...
const _GAkPvG = eventHandler((event) => {
...
const _AYFVnz = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/worksDev/GitHub/builder-blog/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/worksDev/GitHub/builder-blog/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _GoF9hl = lazyEventHandler(() => {
...
const _lazy_KNX7ND = () => Promise.resolve().then(function () { return delete_post$1; });
const _lazy_0gzJcG = () => Promise.resolve().then(function () { return update_post$1; });
const _lazy_GEg3Xy = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_bxKwax = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_cGmaRl = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_RUL3KN = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_RFguRV = () => Promise.resolve().then(function () { return categories_get$1; });
const _lazy_5yWhui = () => Promise.resolve().then(function () { return index_post$3; });
...
const handlers = [
  ...
  { route: '/api/admin/posts/:id/delete', handler: _lazy_KNX7ND, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/posts/:id/update', handler: _lazy_0gzJcG, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/login', handler: _lazy_GEg3Xy, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_bxKwax, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_cGmaRl, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/register', handler: _lazy_RUL3KN, lazy: true, middleware: false, method: "post" },
  { route: '/api/categories', handler: _lazy_RFguRV, lazy: true, middleware: false, method: "get" },
  { route: '/api/comments', handler: _lazy_5yWhui, lazy: true, middleware: false, method: "post" },
  ...
  { route: '/api/_nuxt_icon/:collection', handler: _AYFVnz, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _GoF9hl, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CFOwPR, lazy: true, middleware: false, method: undefined }
];
...
const posts_post = defineEventHandler(async (event) => {
  ...
  if (coverImageFile && coverImageFile.size > 0) {
    ...
    try {
      ...
      if (uploadRes == null ? void 0 : uploadRes.secure_url) {
...
const index_post$2 = defineEventHandler(async (event) => {
  ...
  try {
    ...
    return {
      ...
      authorName: ((_a = comment.author) == null ? void 0 : _a.name) || "Anonymous"
    };
  } catch (error) {
    if (error.statusCode) {
      throw error;
...
const sitemap_xml = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      { url: "/contact", lastmod: (/* @__PURE__ */ new Date()).toISOString(), priority: "0.7" }
    ];
